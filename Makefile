...
Makefile: harbour-countme.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d obj/harbour-countme1.0.0 || mkdir -p obj/harbour-countme1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/harbour-countme1.0.0/ && $(COPY_FILE) --parents src/harbour-countme.cpp obj/harbour-countme1.0.0/ && (cd `dirname obj/harbour-countme1.0.0` && $(TAR) harbour-countme1.0.0.tar harbour-countme1.0.0 && $(COMPRESS) harbour-countme1.0.0.tar) && $(MOVE) `dirname obj/harbour-countme1.0.0`/harbour-countme1.0.0.tar.gz . && $(DEL_FILE) -r obj/harbour-countme1.0.0
...
obj/harbour-countme.o: src/harbour-countme.cpp /usr/include/qt5/QtQuick/QtQuick \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/harbour-countme.o src/harbour-countme.cpp
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/harbour-countme || mkdir -p $(INSTALL_ROOT)/usr/share/harbour-countme
	-$(INSTALL_DIR) /home/mersdk/SailfishOS/projects/harbour-countme/qml $(INSTALL_ROOT)/usr/share/harbour-countme/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/harbour-countme/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/harbour-countme/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_PROGRAM) /home/mersdk/SailfishOS/projects/harbour-countme/harbour-countme.desktop $(INSTALL_ROOT)/usr/share/applications/
	-: $(INSTALL_ROOT)/usr/share/applications/harbour-countme.desktop

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/harbour-countme.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/SailfishOS/projects/harbour-countme/harbour-countme.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/
	-: $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-countme.png

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/harbour-countme.png
